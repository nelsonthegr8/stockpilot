  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        {["ADMIN", "MANAGER"].includes(role ?? "") ? <Button asChild><Link href="/dashboard/orders/new"><Plus className="mr-2 h-4 w-4" />New Order</Link></Button> : null}
      </div>
