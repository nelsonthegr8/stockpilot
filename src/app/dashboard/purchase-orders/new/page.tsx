...
export default function NewPurchaseOrderPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      <PageHeader title="New Purchase Order" description="Create a replenishment PO or internal production batch." back={{ href: "/dashboard/purchase-orders", label: "Purchase Orders" }} action={<Button onClick={createPo}>Create PO</Button>} />
